      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h1 style={{
            ...
            Data <span style={{ color: ACCENT }}>Visualization</span>
          </h1>
          <p style={{
            fontSize: 15, color: "rgba(255,255,255,0.4)", margin: "14px 0 0",
            fontWeight: 400, letterSpacing: "0.3px",
          }}>
            Explore your wishlist budget data through different visual perspectives
          </p>
        </div>
        ...
        {empty ? (
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            {VIZ_OPTIONS.map((viz) => (
              <VizCard key={viz.id} viz={viz} onClick={() => navigate(`/visualize/${viz.id}`)} />
            ))}
          </div>
        )}
      </div>
